...
import { PITCHES_ENABLED } from "@/lib/features"
...
const tabs = [
  ...
  { label: "Pitches", href: "/budget/pitches", matchPrefix: "/budget/pitches", flagged: true },
  { label: "Shelved", href: "/budget/shelved", matchPrefix: "/budget/shelved" },
]

export function BudgetTabNav() {
  const pathname = usePathname()
  const visibleTabs = tabs.filter((tab) => !tab.flagged || PITCHES_ENABLED)
